...
\draw node[fill=blue!50, circle, width=2cm] (l1) at (4, 1) {$u^{0}_{i,j}$};
\draw node[fill=green!50, circle, width=2cm] (W1) at (4, -1) {$W^{0}_{i,j}$};
\draw node[fill=green!50, circle, width=2cm] (t1) at (4, -2.5) {$\theta^{0}_{i}$};
...
\draw node[fill=blue!50, circle, width=2cm] (l2) at (8, 1) {$u^{1}_{i,j}$};
\draw node[fill=green!50, circle, width=2cm] (W2) at (8, -1) {$W^{0}_{i,j}$};
\draw node[fill=green!50, circle, width=2cm] (t2) at (8, -2.5) {$\theta^{0}_{i}$};
...
%ld
\draw node[draw=none, width=2cm] (ld) at (10.5, 1) {$\ldots$};
\draw [->,thick]%
...
%\draw node at (13,-5) {$\frac{dE}{du^{n_h}_{i,j}} = f^1 \left (W^{n_h}_{j,k}u^{n_h}_{i,k} + \theta^{n_h}_j \right )$};
\draw node at (14,-6.05) {%
$\begin{aligned}
  & \\ \\
  \frac{dE}{dW^{n_h}_{i,j}} & = u^{n_h}_{m,j} \left ( f^{n_h} \right )'_{m,i}\frac{dJ}{du^{n_h}_{m,i}} \\
\frac{dE}{d\theta^{n_h}_{i}} & = \left (f^{n_h} \right )'_{m,i} \frac{dE}{du^{n_h}_{m,i}} \\
\end{aligned}$};

\draw[fill=black!20, draw=none] (12,2) rectangle (14,-4) {};
\draw node[fill=blue!50, circle, width=2cm] (lnh) at (13, 1) {$\frac{dE}{du^{n_h}_{i,j}}$};
\draw node[fill=green!50, circle, width=2cm] (Wnh) at (13, -1) {$\frac{dE}{dW^{n_h}_{j,j}}$};
\draw node[fill=green!50, circle, width=2cm] (tnh) at (13, -2.5) {$\frac{dE}{d\theta^{n_h}_{j}}$};

\draw node at (9,-6) {%
$\begin{aligned}
  \frac{dE}{du^{n}_{i,j}} & = W^{l}_{n,j} \left ( f^{n} \right )'_{i,n}\frac{dJ}{du^{n+1}_{i,n}} \\
  \frac{dE}{dW^{n}_{i,j}} & = u^{n}_{m,j} \left ( f^{n} \right )'_{m,i}\frac{dJ}{du^{n}_{m,i}} \\
\frac{dE}{d\theta^{n}_{i}} & = \left (f^{n} \right )'_{m,i} \frac{dE}{du^{n}_{m,i}} \\
\end{aligned}$};
...
\draw node[fill=red!50, circle, width=2cm] (E) at (17, -1) {$E(\mathbf{y},\mathbf{\hat{y}},\mathbf{W})$};
% Error function

\draw [->, thick]%
([xshift=-0.2cm]E.north west) to%
