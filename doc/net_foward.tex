...
%l1
\draw node at (4,2.5) {$u^0_{i,j} = f^0 \left (W^0_{j,k}u^{n_h}_{i,k} + \theta^0_j \right )$};
...
%l2
\draw node at (8,2.5) {$u^1_{i,j} = f^1 \left (W^1_{j,k}x_{i,k} + \theta^1_j \right )$};
...
%lnh
\draw node at (13,2.5) {$u^{n_h+1}_{i,0} = f^1 \left (W^{n_h+1}_{0,k}u^{n_h}_{i,k} + \theta^{n_h+1}_0 \right )$};
\draw[fill=black!20, draw=none] (12,2) rectangle (14,-4) {};
\draw node[fill=blue!50, circle, width=2cm] (lnh) at (13, 1) {$u^{n_h+1}_{i,0}$};
\draw node[fill=green!50, circle, width=2cm] (Wnh) at (13, -1) {$W^{n_h+1}_{0,j}$};
\draw node[fill=green!50, circle, width=2cm] (tnh) at (13, -2.5) {$\theta^{n_h+1}_{0}$};
...
\draw node[fill=red!50, circle, width=2cm] (E) at (19, -1) {$E(\mathbf{y},\mathbf{\hat{y}},\mathbf{W})$};
% Error function

\draw [->, thick]%
([xshift=0.4cm]Y.east) to%
([xshift=-0.2cm]E.west);
