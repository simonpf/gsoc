...
\draw node[fill=blue!50, circle] (l1) at (4, 1) {$\frac{dJ}{du^{1}_{i,j}$};
\draw node[fill=green!50, circle] (W1) at (4, -1) {$\frac{dJ}{dW^{1}_{i,j}}$};
\draw node[fill=green!50, circle] (t1) at (4, -2.5) {$\frac{dJ}{d\theta^{1}_{i}}$};
...
$\begin{aligned}
  \frac{dJ}{du^{n_h}_{i,j}} &\\
  \frac{dJ}{dW^{n_h}_{i,j}} & = u^{n_h-1}_{m,j} \left ( f^{n_h} \right )'_{m,i}\frac{dJ}{du^{n_h}_{m,i}} \\
