...
%  \draw[fill=orange!50, draw = none] (2*\xmargin,2 + 2*\ymargin) rectangle (2-\xmargin,3 - \ymargin)
%        node[pos=.5] {\scriptsize \texttt{TBatch}};
%  \draw[fill=orange!50, draw = none] (2*\xmargin,3 + \ymargin) rectangle (2-\xmargin,4 - 2* \ymargin)
%        node[pos=.5] {\scriptsize \texttt{TDataLoader}};
%  \draw[fill=orange!50, draw = none] (2+\xmargin,2 + 2*\ymargin) rectangle (6-2*\xmargin,3 - \ymargin)
%        node[pos=.5] {\scriptsize \texttt{TLayer}};
%  \draw[fill=orange!50, draw = none] (2+\xmargin,3 + \ymargin) rectangle (6-2*\xmargin,4 - 2* \ymargin)
