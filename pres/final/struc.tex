...
%\node[anchor=south, rotate=90, xshift=-0.2, align=center, text width=2cm] at (0,1) {\scriptsize{Low-level\\ Implementation}};
% Cuda
% \draw (\xmargin,\ymargin) rectangle (2-\xmargin,2-\ymargin);
% \node[anchor=north, yshift=-0.1cm]  at (1,2) {\small\texttt{TCuda}};
% \draw (2*\xmargin,0.9) rectangle (2-2*\xmargin,1.45)
...
% CPU
% \draw (2 + \xmargin,\ymargin) rectangle (4-\xmargin,2-\ymargin);
% \node[anchor=north, yshift=-0.1cm]  at (3,2) {\small\texttt{TCpu}};
% \draw (2 + 2*\xmargin,0.9) rectangle (4-2*\xmargin,1.45)
%       node[pos=.5] {\scriptsize \texttt{TCpuMatrix}};
% \draw (2 + 2*\xmargin,2*\ymargin) rectangle (3-\xmargin,0.9-\ymargin)
%       node[pos=.5] {\tiny \texttt{BLAS}};
% \draw (3 + \xmargin,2*\ymargin) rectangle (4-2*\xmargin,0.9-\ymargin)
%       node[pos=.5] {\tiny \texttt{TBB}};

% % OpenCL
% \draw (4 + \xmargin,\ymargin) rectangle (6-\xmargin,2-\ymargin);
% \node[anchor=north, yshift=-0.1cm]  at (5,2) {\small\texttt{TOpenCL}};
% \draw (4 + 2*\xmargin,0.9) rectangle (6-2*\xmargin,1.45)
%       node[pos=.5] {\scriptsize \texttt{TCpuMatrix}};
% \draw (4 + 2*\xmargin,2*\ymargin) rectangle (5-\xmargin,0.9-\ymargin)
%       node[pos=.5] {\tiny \texttt{BLAS}};
% \draw (5 + \xmargin,2*\ymargin) rectangle (6-2*\xmargin,0.9-\ymargin)
%       node[pos=.5] {\tiny \texttt{TBB}};
\end{tikzpicture}
% End of code
\end{document}
